...
class MachinesControllerTest < ActionController::TestCase
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post :create, machine: { description: @machine.description, name: @machine.name, theme_id: @machine.theme_id }
    end
  ...
  test "should update machine" do
    patch :update, id: @machine, machine: { description: @machine.description, name: @machine.name, theme_id: @machine.theme_id }
    assert_redirected_to machine_path(assigns(:machine))
  end
