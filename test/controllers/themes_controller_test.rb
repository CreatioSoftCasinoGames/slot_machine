...
class ThemesControllerTest < ActionController::TestCase
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post :create, theme: { description: @theme.description, game_id: @theme.game_id, name: @theme.name }
    end
  ...
  test "should update theme" do
    patch :update, id: @theme, theme: { description: @theme.description, game_id: @theme.game_id, name: @theme.name }
    assert_redirected_to theme_path(assigns(:theme))
  end
